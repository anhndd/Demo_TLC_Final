...
class SumoSimulation:
	...
	def _save_stats(self, traffic_code, tot_neg_reward): # save the stats for this episode
		...
		numb_generated_veh = count_veh.cal_numb_generated_veh(constants.simu_type_of_random, is_random = False)
...
def show_infor_fixed():
	...
	if not constants.is_test_random:
		...
		print('\n\n 1. Average waiting time 4 types (STL system): ')
		print('LOW AWT:  ', AWT_L_fixed[0])
		print('HIGH AWT: ', AWT_H_fixed[0])
		print('NS AWT:   ', AWT_NS_fixed[0])
		print('EW AWT:   ', AWT_EW_fixed[0], '\n\n')
	else:
		AWT_CUSTOM_fixed = np.load(constants.plot_path_fixed_sys+'RANDOM/_avg_waiting_time_per_veh.npy')
		print('\n\n 1. Average waiting time RANDOM simulation (STL system): ')
...
def main():
	...
	durations_of_phases = constants.durations_of_phases				# 33, 33 or 40,40
