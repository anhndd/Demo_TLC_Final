...
class SumoSimulation:
	def __init__(self, agent, target_agent, memory, gamma, max_steps, sumoCmd, green_duration, yellow_duration):
		...
		self.list_lane_ids = ['right_in_0','right_in_1','right_in_2','bottom_in_0','bottom_in_1','bottom_in_2','top_in_0','top_in_1','top_in_2']
	...
	def run_one_episode(self, simu_type, total_episodes):
		...
		traci.gui.setZoom('View #0',345)
		traci.gui.setOffset('View #0',223,205)
	...
	def plot_delay(self,data):
		if constants.is_test_random:
			...
			plt.figure('Evaluate simulation')
...
def save_comparation():
	...
	if not constants.is_test_random:
		...
		print('Fixed 33: ', avg_waiting_time_LOW_33)
		print('Fixed 40: ', avg_waiting_time_LOW_40)
		print('Agent: ', avg_waiting_time_LOW_model)
		print('Improvement 33: ', 1 - avg_waiting_time_LOW_model/avg_waiting_time_LOW_33)
		print('Improvement 40: ', 1 - avg_waiting_time_LOW_model/avg_waiting_time_LOW_40)
		print('\n')
			
		print('Compare AWT HIGH: ')
		print('Fixed 33: ', avg_waiting_time_HIGH_33)
		print('Fixed 40: ', avg_waiting_time_HIGH_40)
		print('Agent: ', avg_waiting_time_HIGH_model)
		print('Improvement 33: ', 1 - avg_waiting_time_HIGH_model/avg_waiting_time_HIGH_33)
		print('Improvement 40: ', 1 - avg_waiting_time_HIGH_model/avg_waiting_time_HIGH_40)
		print('\n')

		print('Compare AWT NS: ')
		print('Fixed 33: ', avg_waiting_time_NS_33)
		print('Fixed 40: ', avg_waiting_time_NS_40)
		print('Agent: ', avg_waiting_time_NS_model)
		print('Improvement 33: ', 1 - avg_waiting_time_NS_model/avg_waiting_time_NS_33)
		print('Improvement 40: ', 1 - avg_waiting_time_NS_model/avg_waiting_time_NS_40)
		print('\n')

		print('Compare AWT EW: ')
		print('Fixed 33: ', avg_waiting_time_EW_33)
		print('Fixed 40: ', avg_waiting_time_EW_40)
		print('Agent: ', avg_waiting_time_EW_model)
		print('Improvement 33: ', 1 - avg_waiting_time_EW_model/avg_waiting_time_EW_33)
		print('Improvement 40: ', 1 - avg_waiting_time_EW_model/avg_waiting_time_EW_40)
		print('\n')
		...
		print('Compare AWT RANDOM: ')
		print('Fixed 33: ', round(avg_waiting_time_RANDOM_33[0],2))
		print('Fixed 40: ', round(avg_waiting_time_RANDOM_40[0],2))
		print('Agent: ', round(avg_waiting_time_RANDOM_model[0],2))
		print('Improvement 33: ', round((1 - avg_waiting_time_RANDOM_model/avg_waiting_time_RANDOM_33)[0]*100,2), '%')
		print('Improvement 40: ', round((1 - avg_waiting_time_RANDOM_model/avg_waiting_time_RANDOM_40)[0]*100,2), '%')
		print('\n')
...
def main():
	...
	if sys.argv[2]:
		constants.simu_type_of_random = sys.argv[2]

	if sys.argv[1] == "agent2":
		constants.is_load_Agent_1 = False
		constants.loaded_model_name = "Agent2_200.h5"
	elif sys.argv[1] == "agent1":
		constants.is_load_Agent_1 = True
		constants.loaded_model_name = "Agent1_200.h5"
