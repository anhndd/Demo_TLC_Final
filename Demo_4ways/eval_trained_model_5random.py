...
# phase codes based on xai_tlcs.net.xlim
...
class SumoSimulation:
	...
	# SET IN SUMO A YELLOW PHASE		traci.gui.setZoom('View #0',1500)
		traci.gui.setOffset('View #0',595,916)
...
def main():
	...
	os.makedirs(os.path.dirname(plot_path + constants.simu_type_of_random +'/'), exist_ok=True)
